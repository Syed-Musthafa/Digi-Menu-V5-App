            ...
            <View style={{ width: '100%', }}>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                    ...
                    <View style={{ padding: SIZES.padding, justifyContent: 'center', alignItems: 'flex-start', marginLeft: 10, }}>
                        <Text style={{ fontSize: 16, color: COLORS.white, marginTop: 30 }}>Forgate your password?</Text>
                    </View>
                </View>
            </View>
        )
    ...
    function renderContent() {
        return (
            <View
                ...
                {/* heading */}
                <View>
                    <Text style={{ fontSize: 25, fontWeight: 'bold' }}>Let's get something</Text>
                    <Text style={{ fontSize: 15, color: COLORS.gray1, marginTop: 5 }}>Good to see back</Text>
                </View>
                ...
                <View style={{ marginTop: 50, height: 180, justifyContent: 'flex-end' }}>
                    ...
                    <View style={{ flexDirection:'row', padding:10, justifyContent:'center', alignItems:'center', marginTop:10}}>
                        ...
                        <TouchableOpacity onPress={() => {navigation.navigate('SignUp')}}>
                            <Text style={{ color:"#FBC401", marginLeft:5,fontSize:16}}>Sign Up</Text>
                        </TouchableOpacity>
                    </View>
                </View>
