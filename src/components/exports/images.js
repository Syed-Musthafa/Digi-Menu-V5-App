...
const faceBook = require("../assets/images/facebook3.png");
const twitter = require("../assets/images/Twitter-Icon.png");

const qr = require("../assets/images/qr1.png");
const takeout = require("../assets/images/takeout.png");
